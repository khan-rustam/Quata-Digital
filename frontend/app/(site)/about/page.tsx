    ...
    <>
            ...
            entries={[
              {
                ...
                body: "QUATA Digital Enterprise founded in Bamenda, Cameroon by Neba Clovis Ngwa, with one objective: build next-generation digital infrastructure tailored for African markets.",
                icon: Building2,
              },
              {
                date: "Q3 2025",
      ...
      <Section className="bg-surface-soft rounded-3xl">
        ...
        <div className="mt-10 grid lg:grid-cols-[320px_1fr] gap-8 lg:gap-12 items-start max-w-4xl">
          ...
          />
          <div>
            <div className="text-xl font-semibold tracking-tight">Neba Clovis Ngwa</div>
